...
class Recommendations
  ...
  def sim_pearson( prefs, p1, p2)
    ...
    den = Math.sqrt((sum1Sq.to_f - (sum1.to_f ** 2)/n.to_f) * (sum2Sq.to_f - (sum2.to_f ** 2)/n.to_f))
...
"Fatos"=>{"Slide 1"=>-1, "Slide 2"=>0, "Slide 3"=>1, "Slide 4"=>-1, "Slide 5"=>1, "Slide 6"=>0}} 
  ...
  #  puts recommendations.topMatches(critics,"Toby", 3)
   ...
   puts "recommendations for Zaid"
    puts recommendations.getRecommendations(votes,"Zaid")
